...
//
//  see reference in https://github.com/RestKit/RestKit/wiki/Installing-RestKit-v0.20.x-as-a-Git-Submodule
//
...
- (id)parseJSONData:(NSData *)data error:(NSError **)error
{
    ...
    id result = [RKNSJSONSerialization objectFromData:data error:&parseError];
